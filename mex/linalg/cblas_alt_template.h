...
/* added by Quoc-Tin Phan */
template <typename T> int potrf(char& uplo, INTT n, T *a, INTT lda, INTT info);
template <typename T> int potrs(char& uplo, INTT n, INTT nrhs, T *a, INTT lda, 
      T *b, INTT ldb, INTT info);
...
extern "C" {
   ...
   void ssyev_(char *jobz, char *uplo, INTT *n, float *a, INTT *lda,
    ...
    void dpotrs_(char *uplo, INTT *n, INTT *nrhs, double *a, INTT *lda, 
         double *b, INTT *ldb, INTT *info);
    void spotrs_(char *uplo, INTT *n, INTT *nrhs, float *a, INTT *lda, 
         float *b, INTT *ldb, INTT *info);
}
...
/* added by Quoc-Tin Phan */
template <> int inline potrf(char& uplo, INTT n, float *a, INTT lda, INTT info) {
    spotrf_(&uplo, &n, a, &lda, &info);
    return info;
};

template <> int inline potrf(char& uplo, INTT n, double *a, INTT lda, INTT info) {
    dpotrf_(&uplo, &n, a, &lda, &info);
    return info;
};

template <> int potrs(char& uplo, INTT n, INTT nrhs, float *a, INTT lda, 
      float *b, INTT ldb, INTT info) {
    spotrs_(&uplo, &n, &nrhs, a, &lda, b, &ldb, &info);
    return info;
}

template <> int potrs(char& uplo, INTT n, INTT nrhs, double *a, INTT lda, 
      double *b, INTT ldb, INTT info) {
    dpotrs_(&uplo, &n, &nrhs, a, &lda, b, &ldb, &info);
    return info;
}
/* ended by Quoc-Tin Phan */
